...
onEvent('tags.fluids', event => {
	event.add('createaddition:burnable_fuel_1800', 'techreborn:biofuel')
	event.add('createaddition:burnable_fuel_3600', 'techreborn:nitrofuel')
	...
	event.add('createaddition:burnable_fuel_4800', 'ad_astra:fuel')
