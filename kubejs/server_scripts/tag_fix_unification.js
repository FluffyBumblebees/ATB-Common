...
onEvent('tags.items', event => {
	...
	event.add('c:raw_titanium_ores', 'agape_space:raw_titanium')
	...
	event.remove('c:aluminum_ingots', 'agape_space:aluminum_ingot')
	...
	event.remove('c:aluminum_plates', 'agape_space:aluminum_plate')
	...
	event.remove('c:iron_plates', 'agape_space:iron_plate')
	...
	event.remove('c:gold_plates', 'agape_space:gold_plate')
	...
	event.remove('c:copper_plates', 'agape_space:copper_plate')
